...
def cal_selling_price():
	...
	for i in items:
		...
		if frappe.db.exists("Item Price", {"item_code": i.item_code,"price_list":"Standard Selling","selling":1}):
			name = frappe.get_value('Item Price',{'item_code': i.item_code,'price_list':'Standard Selling','selling':1},'name')
